<template>
    <div class="main-footer">
        <div class="filling-footer d-flex">
            <div class="filling-footer-left">
                <img :src="logo" alt="">
                <p class="text">Hot Africa, we offer original, exclusive and premium stories. Everything you want to watch, anytime, anywhere and as much.</p>
            ...
            <div class="filling-footer-right d-flex">
                <div class="column1">
                    <p class="lable">Sign in</p>
                    <p class="point">Personal data</p>
                    <p class="point">Choosing a Plan</p>
                    <p class="point">Payment</p>
                </div>
                <div class="column2">
                    <p class="lable">Movies</p>
                    <p class="point">Lock Upp</p>
                    <p class="point">Pavitra Rishta</p>
                    <p class="point">Girgit</p>
                    <p class="point">Hai Taubba Season 3</p>
                    <p class="point">Cartel</p>
                    <p class="point">Crimes And Confessions</p>
                    <p class="point">Puncch Beat Season 2</p>
                    <p class="point">Broken But Beautiful Season 3 </p>
                </div>
                <div class="column3">
                    <p class="lable">Series</p>
                    <p class="point">X.X.X. Season 2</p>
                    <p class="point">Gandii Baat Season 5</p>
                    <p class="point">Gandii Baat Season 6</p>
                    <p class="point">Broken But Beautiful Season 1</p>
                    <p class="point">Broken But Beautiful Season 2</p>
                    <p class="point">Class Of 2020</p>
                    <p class="point">Bekaaboo Season 1</p>
                    <p class="point">Ragini MMS Returns Season 2</p>
                </div>
            </div>
        </div>
    </div>
